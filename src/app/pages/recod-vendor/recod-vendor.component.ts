...
@Component({
  selector: 'app-recod-vendor',
  templateUrl: './recod-vendor.component.html',
  styleUrls: ['./recod-vendor.component.css']
})
export class RecodVendorComponent implements OnInit, AfterViewInit {
