...
@Component({
  selector: 'app-recod-query-cpu',
  templateUrl: './recod-query-cpu.component.html',
  styleUrls: ['./recod-query-cpu.component.css']
})
export class RecodQueryCpuComponent implements OnInit, AfterViewInit {
