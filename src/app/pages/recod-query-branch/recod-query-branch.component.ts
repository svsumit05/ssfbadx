...
@Component({
  selector: 'app-recod-branch',
  templateUrl: './recod-query-branch.component.html',
  styleUrls: ['./recod-query-branch.component.css']
})
export class RecodQueryBranchComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.columns = [
      ...
      {
        title: 'AWB no',
        data: 'branchDocumentRecord.awbNo'
      },
      {
        title: 'Physical Copy',
      ...
      },
      {
        ...
        data: '',
        render: (data, type, row) => {
          return '<button type="button" class="btn approve-button">Received</button>';
        }
      },
      {
        title: '',
      ...
      },
      {
        ...
        data: '',
        render: (data, type, row) => {
          return '<button type="button" class="btn">SENT TO VENDOR</button>';
        }
      }];
