...
@Component({
  selector: 'app-recod-branchaction',
  templateUrl: './recod-query-branchaction.component.html',
  styleUrls: ['./recod-query-branchaction.component.css']
})
export class RecodQueryBranchactionComponent implements OnInit, AfterViewInit {
